    ...
    CredentialsProvider({
      ...
      async authorize(credentials) {
        const DEMO: Record<string, any> = {
          ...
          "priya@patel.co.za": { id:"p1",email:"priya@patel.co.za",name:"Mrs. Priya Patel",role:"PARENT",schoolId:undefined,schoolName:undefined,grade:undefined,pin:undefined,linkedStudentId:undefined,language:"en" },
